class ReportPdf < Prawn::Document
  ...
  def text_content
    ...
    bounding_box([0, y_position], :width => 540, :height => 100) do
  ...
  def product_rows
    [['#', 'First Name', 'Middle Name', 'Last Name', 'Father Name', 'Mother Name', 'Date of Birth','Age','Contact','Email']] +
      @admissions.map do |admission|
      [admission.id, admission.first_name, 
        admission.middle_name, admission.last_name,
        admission.father_name,admission.mother_name,
        admission.date_of_birth,admission.age,admission.contact,
        admission.email]
    end
  end
end